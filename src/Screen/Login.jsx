  ...
  return (
    ...
    >
      <G data-name="Group 102">
        ...
        <Text style={{ fontSize: 20, fontWeight: "bold", color: "#0F2573" }}>
          My Account
        </Text>
      </View>
      <View style={styles.secondcontainer}>
        ...
        <TouchableOpacity style={styles.startView} onPress={() => navigation.navigate('ForgetPassword')}>
          <Text style={styles.forgetPassword}>Forget your password?</Text>
        </TouchableOpacity>
      </View>
      <View style={styles.thirdcontainer}>
        <TouchableOpacity onPress={() => navigatetoRegister()} >
          <Text style={{ fontSize: 20, fontWeight: "bold", color: "#4287C8" }}>
            REGISTER NOW
          </Text>
        </TouchableOpacity >
